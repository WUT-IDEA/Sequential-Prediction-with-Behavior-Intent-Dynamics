...
class Embedding(object):
    """sampling mutual importance learning, multiple base models(bert)"""
...
def create_initializer(initializer_range=0.02, name='truncated_normal_initializer'):
    """Creates a `truncated_normal_initializer` with the given range."""
    if name=='xavier ':
        return xavier_initializer()
    elif name=='he':
        return tf.compat.v1.keras.initializers.he_normal()
